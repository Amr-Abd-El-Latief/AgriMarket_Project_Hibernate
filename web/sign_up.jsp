                        ...
                        <div class="mbr-box__magnet mbr-class-mbr-box__magnet--center-left col-sm-5 mbr-section__right">
                            ...
                            <div class="mbr-section__container mbr-section__container--middle">
                                <div class="mbr-header mbr-header--auto-align mbr-header--wysiwyg">
                                    <input type="text" class="form-control" name="name" required="" value = 'user' placeholder="User Name*">
                            ...
                            <div class="mbr-section__container mbr-section__container--middle">
                                <div class="mbr-article mbr-article--auto-align mbr-article--wysiwyg">
                                    <input id="user-email" type="email" class="form-control" name="mail" required=""  value = 'email' placeholder="Email*">

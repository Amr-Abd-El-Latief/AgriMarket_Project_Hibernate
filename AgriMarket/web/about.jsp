...
<body>
<section class="engine"><a rel="external" href="https://mobirise.com">Mobirise responsive website builder
</a></section>
            ...
            <div class="mbr-navbar__container">
                <div class="mbr-navbar__column mbr-navbar__column--s mbr-navbar__brand">
                    <span class="mbr-navbar__brand-link mbr-brand mbr-brand--inline">
                        <span class="mbr-brand__logo"><a href="index.jsp"><img class="mbr-navbar__brand-img mbr-brand__img" src="assets/images/untitled-382x276-17.png" alt="AgriMarket" title="AgriMarket"></a></span>
...
<section class="mbr-section mbr-section--relative mbr-after-navbar" id="msg-box4-26" style="background-color: rgb(68, 68, 68);">
    
    <div class="mbr-section__container mbr-section__container--isolated container">
        <div class="row">
            <div class="mbr-box mbr-box--fixed mbr-box--adapted">
                <div class="mbr-box__magnet mbr-box__magnet--top-right mbr-section__left col-sm-6">
                    <figure class="mbr-figure mbr-figure--adapted mbr-figure--caption-inside-bottom mbr-figure--full-width"><img class="mbr-figure__img" src="assets/images/f7fac774df28c580ca230ae40c87e5a4-564x575-56.jpg"></figure>
                </div>
                <div class="mbr-box__magnet mbr-class-mbr-box__magnet--center-left col-sm-6 mbr-section__right">
                    ...
                    <div class="mbr-section__container mbr-section__container--middle">
                        <div class="mbr-article mbr-article--auto-align mbr-article--wysiwyg"><p>Flower shop is a reputed online florist delivering pretty and prim flower bouquets to Egypt. Started 18 years ago, Flower shop is involved in many aspects of florist from gift bouquets to dazzling weddings to corporate events. Their flowers are distinct and exquisite as they are mostly imported from Holland.</p><p>We have an excellent team of dedicated florists who are passionate about what they create, and dependable drivers and assistants to assure that we can provide the absolute best florist service possible.</p><p>We are proudly expanding soon to Saudi Arabia, Qatar, Kuwait, Bahrain, and many more. Send flowers to Dubai or Send Flowers to Egypt with Flower shop to deliver a stunning bouquet directly to your specified destination.</p></div>
                    </div>
                    <div class="mbr-section__container">
                        <div class="mbr-buttons mbr-buttons--auto-align btn-inverse"><a class="mbr-buttons__btn btn btn-lg btn-default" href="contact_us.jsp">CONTACT US</a></div>
                    </div>
                </div>
